...
const gAllTables: Stash<SketchTable> = {};
...
export function generateFetchPaths(table: SketchTable, fields: Stash<Field>, rootIdPath: (string | number)[]): FetchPath[] {
...
export function buildRowKey(sqlTable: SketchTypes.SqlTable, keyValues: Stash<string>) {
...
function addFilteredField(sketchTable: SketchTable, filteredFields: Stash<Field>, fieldFilter: FieldFilter, fieldPath, isInMask) {
...
export function addIndex(sqlTable: SketchTypes.SqlTable, indexFields: Stash<1>, indexParams?: SketchTypes.IndexParams) {
  if (gSqlInited) {
